BigQueryJavaGettingStarted - sample code that demonstrated the basics for
using the Google BigQuery API with Java.
...
About
=====
This code is a simple demonstration of how to get started with incorporating
the BigQuery Service API in your own Java-based applications, using the
...
For Maven users, see the included pom.xml file for repository and dependency
information.
